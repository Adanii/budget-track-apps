                  ...
                  background: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          context.colors.expense.withValues(alpha: 0.3),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: isLarge
                                  ? context.colors.expense.withValues(
                                      alpha: 0.4,
                                    )
                        ...
                        ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: context.colors.expense,
                                shadowColor: context.colors.expense.withValues(
                                  alpha: 0.4,
                                ),
                                elevation: 8,
                              ),
